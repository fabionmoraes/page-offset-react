...
var Page = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ style: { display: "flex" } }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ style: { display: "flex" }, className: (custom_class === null || custom_class === void 0 ? void 0 : custom_class.page) || "page-offset" }, { children: [resultNav.pages[0] === 2 && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("button", __assign({ type: "button", onClick: function () { return handlePage && handlePage("1"); } }, { children: "1" }), void 0) }, void 0)), resultNav.pages[0] === 3 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("button", __assign({ type: "button", onClick: function () { return handlePage && handlePage("1"); } }, { children: "1" }), void 0), (0, jsx_runtime_1.jsx)("small", __assign({ style: { marginRight: "6px" } }, { children: "..." }), void 0)] }, void 0)), resultNav.pages[0] >= 4 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("button", __assign({ type: "button", onClick: function () { return handlePage && handlePage("1"); } }, { children: "1" }), void 0), (0, jsx_runtime_1.jsx)("button", __assign({ type: "button", onClick: function () { return handlePage && handlePage("2"); } }, { children: "2" }), void 0), (0, jsx_runtime_1.jsx)("small", __assign({ style: { marginRight: "6px" } }, { children: "..." }), void 0)] }, void 0)), resultNav.pages.map(function (item) { return ((0, jsx_runtime_1.jsx)("button", __assign({ type: "button", className: Number(page) === item ? "active" : "nd", onClick: function () { return handlePage && handlePage(String(item)); } }, { children: item }), item)); }), resultNav.pages[minNumber - 1] <= resultNav.totalPages - 2 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("small", __assign({ style: { marginRight: "6px" } }, { children: "..." }), void 0), (0, jsx_runtime_1.jsx)("button", __assign({ type: "button", onClick: function () {
